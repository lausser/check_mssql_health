...
for my $path (
	"$FindBin::Bin/check_mssql_health.t",
	"$root/plugins-scripts/check_mssql_health.pl",
	"$root/plugins-scripts/Classes/Device.pm",
	"$root/plugins-scripts/Classes/Sybase/DBI.pm",
	"$root/plugins-scripts/Classes/Sybase/Sqsh.pm",
	"$root/plugins-scripts/Classes/Sybase/SqlRelay.pm",
	"$root/plugins-scripts/Classes/MSSQL/SqlRelay.pm",
	"$root/plugins-scripts/Classes/ASE/SqlRelay.pm",
	"$root/plugins-scripts/Classes/APS/SqlRelay.pm",
) {
...
my $device = slurp("$root/plugins-scripts/Classes/Device.pm");
like($device, qr/elsif \(\$self->opts->method eq "sqlcmd"\) \{\s*# sqlcmd follows the sqsh code path.*?bless \$self, "Classes::Sybase::Sqsh";/s, 'sqlcmd uses sqsh backend');
like($device, qr/elsif \(\$self->opts->method eq "sqlrelay"\) \{\s*bless \$self, "Classes::Sybase::SqlRelay";/s, 'sqlrelay uses matching package');
