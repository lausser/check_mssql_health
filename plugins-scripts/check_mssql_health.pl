...
my @modes = (
  ...
  ['server::database::autogrow::file',
      'database-file-auto-grow', undef,
      'The number of File Auto Grow events (either data or log) in the last <n> minutes (use --lookback)' ],
  ['server::database::autogrow::logfile',
      'database-logfile-auto-grow', undef,
      'The number of Log File Auto Grow events in the last <n> minutes (use --lookback)' ],
  ['server::database::autogrow::datafile',
      'database-datafile-auto-grow', undef,
